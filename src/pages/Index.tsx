          ...
          <div className="container mx-auto px-4 text-center md:text-left md:flex items-center">
            <div className="md:w-1/2 pb-10 md:pb-0">
              ...
              <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
                <Button 
                  size="lg" 
                  className="bg-white text-clean-blue hover:bg-blue-50"
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="w-20 h-20 rounded-full bg-clean-blue text-white flex items-center justify-center mx-auto mb-4 text-2xl font-bold">1</div>
              ...
              <div className="text-center">
                <div className="w-20 h-20 rounded-full bg-clean-blue text-white flex items-center justify-center mx-auto mb-4 text-2xl font-bold">2</div>
              ...
              <div className="text-center">
                <div className="w-20 h-20 rounded-full bg-clean-blue text-white flex items-center justify-center mx-auto mb-4 text-2xl font-bold">3</div>
                <h3 className="text-xl font-semibold mb-2">Track Progress</h3>
                <p className="text-gray-600">Follow the status updates of your complaint.</p>
              </div>
              
              <div className="text-center">
                <div className="w-20 h-20 rounded-full bg-clean-blue text-white flex items-center justify-center mx-auto mb-4 text-2xl font-bold">4</div>
        ...
        <section className="py-16 bg-gray-900 text-white">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                <div className="text-4xl font-bold text-clean-blue mb-2">5000+</div>
                <p className="text-gray-300">Issues Resolved</p>
              </div>
              
              <div>
                <div className="text-4xl font-bold text-clean-blue mb-2">10+</div>
                <p className="text-gray-300">Cities Covered</p>
              </div>
              
              <div>
                <div className="text-4xl font-bold text-clean-blue mb-2">98%</div>
                <p className="text-gray-300">Resolution Rate</p>
              </div>
              
              <div>
                <div className="text-4xl font-bold text-clean-blue mb-2">24h</div>
